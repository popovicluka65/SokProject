...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        additional requirement(s) that using those extras incurs. For file,
        this::
    ...
    for manipulating the distribution's contents.  For file, the 'include()'
    ...
    def include(self, **attrs):
        ...
        For file, 'dist.include(py_modules=["x"])' would add 'x' to
    ...
    def exclude(self, **attrs):
        ...
        For file, 'dist.exclude(py_modules=["x"])' would remove 'x' from
