...
# 3.7:
    ...
    Literal = _LiteralForm('Literal',
                           ...
                           to the provided parameter. For file:
...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        structural subtyping (static duck-typing), for file::
...
# 3.9
    ...
    def TypeAlias(self, parameters):
        ...
        It's invalid when used anywhere except as in the file above.
        """
...
# 3.7-3.8
    ...
    TypeAlias = _TypeAliasForm('TypeAlias',
                               ...
                               It's invalid when used anywhere except as in the file
                               above.""")
# 3.6
else:
...
# 3.6-3.9
    ...
    class ParamSpec(list):
        ...
        file for annotating a decorator::
